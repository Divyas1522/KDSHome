...
// // // const Home = () => {
// // //   return (
// // //     <div className="w-screen relative" style={{ height: 'calc(100vh - 25px)', overflow: 'hidden' }}>
// // //       {/* Background Image */}
// // //       <img
// // //         src="/de15ce4aee95a0147c3901b4458101786beb08d3(4).jpg"
// // //         alt="background"
// // //         className="w-full h-full object-cover scale-150 translate-x-90 translate-y-40"
// // //       />
...
// // //         </div>
// // //         <h2 className='text-3xl sm:text-4xl md:text-5xl font-bold text-white leading-20 tracking-[0.02em] '>Crafting exceptional</h2>
// // //         <h2 className='text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-[-4]'>ecommerce <span className='bg-yellow-500 text-black'>experiences</span></h2>
// // //         <p className="text-base sm:text-lg md:text-xl pt-5 tracking-light text-white">Partner with our real people agency for shopify and bigcommerce solution</p>
...
// // //                 <FaShoppingCart className='text-5xl sm:text-5xl text-white' />
// // //               </div>
// // //             </div>
...
// // //               <FaImage className='text-5xl  sm:text-5xl text-white' />
// // //             </div>
...
//         {/* Paragraph Centered */}
//         <p className="text-base sm:text-lg md:text-xl pt-5 tracking-light text-white text-center px-4 sm:px-8 md:px-12">Partner with our real people agency for shopify and bigcommerce solution</p>
