...
// //   return (
// //     <nav className="bg-[#FFFFFF] text-black px-6 py-7 flex justify-between items-center shadow-md ">
...
// //       <div className="space-x-8 text-xl pr-22 ">
// //         <Link
// //           to="/"
...
// //         <Link
// //           to="/contact"
// //           className={`px-6 py-3 border-2 rounded-full border-black ${currentPath === '/contact'
// //               ? 'bg-[#3C83CB] text-gray-900 rounded-full border-2 border-white' : 'hover:text-black'
// //             }`}
// //         >
// //           Contact Us
// //         </Link>
